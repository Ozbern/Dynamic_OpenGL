...
public class ShaderUtils {
    public static int createProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (linkStatus[0] == 0) {
            Log.e("Shader_logs", "Error link program: " + glGetProgramInfoLog(programId));
    ...
    static int createShader(int type, String shaderText) {
        ...
        if (compileStatus[0] == 0) {
            Log.e("Shader_logs", "Error compiling shader type: " + type + ". ErrorText: " + glGetShaderInfoLog(shaderId));
